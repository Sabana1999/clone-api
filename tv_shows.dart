...
class TvShows extends StatefulWidget {
  ...
  @override
  State<TvShows> createState() => _TvSeriesState();
}

class _TvSeriesState extends State<TvShows> {
  ...
  var popularurl = 'https://api.themoviedb.org/3/tv/popular?api_key=$api';
  var top_ratedurl =
      'https://api.themoviedb.org/3/tv/top_rated?api_key=$api';
  var upcomingurl = 'https://api.themoviedb.org/3/tv/on_the_air?api_key=$api';
  var airing_today =
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Column(
              ...
              children: [
                slider(populartvseries, "Popular tv shows", "tv", 20),
                slider(topratesseries, "Top-rated tv shows", "tv", 20),
                slider(upcomingseries, "On-the-air", "tv", 20),
                                slider(airingtoday, "Airing Today ", "tv", 20),
