...
import 'package:clone/hime_page.dart/function/fun2.dart';
import 'package:clone/hime_page.dart/function/fun3.dart';
...
class GamesPage extends StatefulWidget {
  ...
  @override
  State<GamesPage> createState() => _TvSeriesState();
}

class _TvSeriesState extends State<GamesPage> {
              ...
              child: Column(
                ...
                children: [
                 const Row(
                  ...
                  slider2(populartvseries, "Popular Games", "tv", 20),
                  slider1(topratesseries, "Mobile Games", "tv", 20),
                  slider1(upcomingseries, "Toprated Games", "tv", 20),
